                        ...
                        <div class="col-md-12">
                            ...
                            <?php 
                                foreach($teams as $lkey => $tt)
                                {
                                    ...
                                    if(search_exif($tt['staff'],$cid) || ($tt['staffid'] == $cid) || is_admin())
                                    {
                                        ...
                                        {
                                             echo "<a href='".admin_url('hr_profile/member/').$staf['staffid']."'>".staff_profile_image($staf['staffid'],array('staff-profile-image'),'small',["data-toggle"=>"tooltip","data-original-title"=>$staf['full_name']])."</a> ";
                                            // echo $staf['full_name'].' ';
                                        }
                                    }else{
                                        continue;

                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="tw-flex tw-items-center tw-space-x-3">
                                            ...
                                            <a href="<?php echo admin_url('leads/delete_type/' . $source['id']); ?>"
...
<div class="modal fade" id="source" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <?php echo form_open(admin_url('leads/type')); ?>
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                        aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">
                    <span class="edit-title"><?php echo _l('edit_type'); ?></span>
                    <span class="add-title"><?php echo _l('lead_new_type'); ?></span>
                </h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php echo render_input('name', 'leads_type_add_edit_name'); ?>
                    </div>
                </div>
            </div>

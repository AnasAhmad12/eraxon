    ...
    <div class="row">
          ...
          echo ' hide';
            ...
            <div class="col-md-4 col-xs-12 lead-information-col">
                ...
                <dl>
                    ...
                    <dt class="lead-field-heading tw-font-medium tw-text-neutral-500">
                        <?php echo _l('lead_type'); ?></dt>    
                    <dd class="tw-text-neutral-900 tw-mt-1 mbot15">
                        <?php echo(isset($lead) && $lead->type_name != '' ? $lead->type_name : '-') ?></dd>
                    ...
                    <?php } ?>
                    <dt class="lead-field-heading tw-font-medium tw-text-neutral-500">
                        <?php echo _l('lead_add_edit_closed'); ?></dt>
                    <dd class="tw-text-neutral-900 tw-mt-1 mbot15">
        ...
        <div class="lead-edit<?php if (isset($lead)) {
            ...
            <div class="col-md-4">
               ...
               echo render_select('assigned', $member1, ['staffid', ['firstname', 'lastname','email']], 'lead_add_edit_closed', $selected, $assigned_attrs); ?>
            </div>
            ...
            $assigned_attrs2 = [];
            if (isset($lead)) {
                $selected2 = $lead->type_name;
            } elseif (isset($status_id)) {
                $selected2 = $status_id;
            }

            $selected3 = (isset($lead) ? $lead->lead_type : get_option('leads_default_source'));

            //echo render_leads_status_select($statuses, $selected, 'lead_add_edit_status');
            echo render_select('lead_type',$types,[ 'id', [ 'name']], 'lead_type',$selected3, $assigned_attrs2);
          ?>

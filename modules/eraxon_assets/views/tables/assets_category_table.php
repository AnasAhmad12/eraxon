...
foreach ($rResult as $aRow) {
    ...
    if (has_permission('asset-category', '', 'edit')) {
    ...
    if (has_permission('asset-category', '', 'delete')) {
        $options .= icon_btn('eraxon_assets/eraxon_assets_categories/delete_category/'.$aRow['assets_category_id'], 'fa fa-remove', 'btn-danger _delete');
    }

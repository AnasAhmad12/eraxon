                                        ...
                                        <tr>
                                            ...
                                            <div class="tw-flex tw-items-center tw-space-x-3">
                                                ...
                                                <?php //}
                                                    ...
                                                    if($salar_detail->status == 'paid' && $salar_detail->ack_status == 'unseen')
                                                    {
                                                       ?>
                                                       
                                                       <a href="<?php echo admin_url('eraxon_payroll/my_salary_slip_status/' . $salar_detail->id); ?>" class="tw-mt-px tw-text-neutral-500 hover:tw-text-neutral-700 focus:tw-text-neutral-700 ">
                                                            <!-- <i class="fa-regular fa-trash-can fa-lg"></i> -->
                                                            Received
                                                        </a>
...
function edit_status(invoker, id) {
    ...
    $('#salary_slip_modal #additional').append(hidden_input('id', id));

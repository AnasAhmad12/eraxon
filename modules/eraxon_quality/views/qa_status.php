                                ...
                                <tr>
                                	...
                                	<td>
                                        ...
                                        if(has_permission('eraxon_qa','','delete')  || is_admin()){ ?>
                                            <a href="<?php echo admin_url('eraxon_quality/delete_qa_status/' . $as['id']); ?>" class="tw-mt-px tw-text-neutral-500 hover:tw-text-neutral-700 focus:tw-text-neutral-700 _delete">
...
<div class="modal fade" id="qa_status_modal" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <?php echo form_open(admin_url('eraxon_quality/qa_status')); ?>
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                        aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">
                    <span class="edit-title">Edit QA Status</span>
                    <span class="add-title">Add QA Status</span>
                </h4>
            </div>

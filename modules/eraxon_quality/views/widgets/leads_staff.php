...
<?php hooks()->add_action('qa_js', 'qa_monthly_function');

function qa_monthly_function(){
    echo "
    console.log(\"Stafff\");
    ...
    function report_by_qa(id, value, title_c){
        ...
        requestGetJSON('eraxon_quality/report_by_leads_qa').done(function (response) {

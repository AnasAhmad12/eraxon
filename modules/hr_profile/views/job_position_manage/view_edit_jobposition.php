													...
													<div class="col-md-12 panel-padding">
														<table class="table border table-striped table-margintop">
															<tbody>
																...
																<tr class="project-overview">
																	<td class="bold"><?php echo _l('hr_basic_salary'); ?></td>
																	<td><?php echo html_entity_decode('Rs. '.$job_position_general->basic_salary) ; ?></td>
																</tr>

																<tr class="project-overview">
																	<td class="bold"><?php echo _l('hr_basic_target'); ?></td>
																	<td><?php echo html_entity_decode($job_position_general->basic_target) ; ?></td>
																</tr>

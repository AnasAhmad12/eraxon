...
/*
Module Name: Eraxon Shop
Module URI: https://eraxon.com
Description: Ecommerce module for Eraxon CRM (Sell Products & Services)
Version: 1.2.3
Requires at least: 2.3.*
Author: Anas Ahmad
Author URI: https://eraxon.com
*/
...
//Shoaib Tariq
hooks()->add_action('admin_init', 'eraxon_purchase_permissions');
function eraxon_purchase_permissions($permissions)
{
    $config = [];
    $config['capabilities'] = [
        'view' => _l('permission_view') . '(' . _l('permission_global') . ')',

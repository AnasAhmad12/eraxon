        ...
        <div class="panel_s">
          <div class="panel-body">
            ...
            <div class="row">
             ...
             <div class="row">
                <div class="col-md-12">
                <?php echo render_input('product_code', 'product_code', $product->product_code ?? ''); ?>
              </div>
             </div>
            <div class="row">
              <div class="col-md-12">
            ...
            <div class="row">
              ...
              <div class="col-md-2">
                <?php echo render_input('quantity_number', 'quantity', $product->quantity_number ?? '', 'number',['min'=>"1"]); ?>
              </div>
              <div class="col-md-4">
                          ...
                          <?php
                            ...
                            foreach ($product->variations as $product_variation) {
                              ...
                              <tr class="variation_value">
                                ...
                                <td><input name="variations[product_code][]" class="form-control product_code" value="<?php echo $product_variation->product_code ?>" /></td>

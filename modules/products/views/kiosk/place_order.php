	...
	<div class="content">
		<div class="panel_s section-heading section-products">
		    <div class="panel-body">
		        <h4 class="no-margin section-text"><?php echo _l('place_order'); ?><a href="<?php echo admin_url('products/kiosk') ?>">(Back to Shop)</a></h4>
		...
		<?php echo form_hidden('clientid', get_staff_user_id()); ?>
		<?php $total = 0; ?>
	<div class="row">
		<div class="col-md-12">
			<div class="panel_s">
            ...
            <div class="col-md-6 col-md-offset-6">
                <table class="table text-right">
                    <tbody>
                        <tr id="psubtotal">
                            <td>
                                <span class="bold"><?php echo _l('psubtotal');?></span>
                            </td>
                            <td class="psubtotal">
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="text-danger ptotal"><?php echo app_format_money($total + $shipping_cost, $base_currency->name); ?></span>
                            </td>
                        </tr>
                    </tbody>
                </table>
...
<?php } ?>
<script type="text/javascript" src="<?php echo module_dir_url('products', 'assets/js/staff_place_order.js'); ?>"></script>
...
// });
        ...
        let sessionData={'sessionId':localStorage.getItem('session_Id')};
        let subTotal;

        console.log("Seesion Dat",sessionData);
     ...
     var a= $("input[name='payment_date']").val("<?php echo date('Y-m-d'); ?>");
        ...
        if (selectedStatus === "" || purchaseDate === "") {
            ...
            if(purchase_items.length>0){
             console.log(selectedDate);
                $.ajax({
                    url: site_url+'products/purchase/make_purchase',
                    type: "POST",
                    data: {
...
<script type="text/javascript" src="<?php echo module_dir_url('products', 'assets/js/item_place_order.js'); ?>"></script>
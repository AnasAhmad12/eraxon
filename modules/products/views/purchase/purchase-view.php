      ...
      <div class="col-md-12">
        <div class="panel_s " id="TableData">
          <div class="panel-body">
            ...
            <a href="<?php echo admin_url('products/purchase/add_purchase'); ?>" class="btn btn-info pull-left display-block">
                    	...
                    	<table class="table dt-table" data-order-col="1" data-order-type="asc">
                            ...
                            <?php foreach ($purchases as $row): ?>
                                <tr data-id=<?php echo $row->id ?>>
                                    ...
                                    <td><b><?php echo $row->grand_total; ?> PKR </b></td>
                                    <td><b> <?php if($row->payment_status=="Pending"){
                                    ...
                                    <?php if(has_permission('purchase','','delete')){ ?>
                                        <button class="btn btn-danger btn-sm remove-from-cart"  <?php if($row->payment_status=="Approved") echo "disabled" ?> id="purchase_delete"><i class="fas fa-trash-alt"></i></button>     
                                     <?php }?>
                                        ...
                                        <button class="btn btn-primary btn-sm remove-from-cart" <?php if($row->payment_status=="Approved") echo "disabled" ?> id="purchase_edit"><i class="fas fa-edit"></i></button>
                                        <?php echo form_close(); ?>
                                        <?php }?>
